            ...
            <div className='flex overflow-x-auto  py-20 '>
                <div className="item group border  cursor-pointer mx-4">
                    ...
                    <div className={`h-[188px] w-96 transition-all hidden  group-hover:flex flex-col justify-center items-center `}>
                        ...
                        <a href='https://github.com/Baranplt/React-Shoping-Project-Responsive' target='_blank' className=' border text-white py-2 px-4 mt-5  hover:scale-110'>Projeye git</a >
                    </div>
                ...
                <div className="item group border  cursor-pointer mx-4">
                    ...
                    <div className={`h-[188px] w-96 transition-all hidden  group-hover:flex flex-col justify-center items-center `}>
                        ...
                        <a href='https://github.com/Baranplt/react-shopping-project' target='_blank' className=' border text-white py-2 px-4 mt-5 hover:scale-110'>Projeye git</a >
                    </div>
                ...
                <div className="item group border  cursor-pointer mx-4">
                    ...
                    <div className={`h-[188px] w-96 transition-all hidden  group-hover:flex flex-col justify-center items-center `}>
                        ...
                        <a href='https://github.com/Baranplt/React-Example---Task-crud-app' target='_blank' className=' border text-white py-2 px-4 mt-5 hover:scale-110'>Projeye git</a >
                    </div>
                ...
                <div className="item group border  cursor-pointer mx-4">
                    ...
                    <div className={`h-[188px] w-96 transition-all hidden  group-hover:flex flex-col justify-center items-center `}>
                        ...
                        <a href='https://github.com/Baranplt/supermarket-barcod-system' target='_blank' className=' border text-white py-2 px-4 mt-5 hover:scale-110'>Projeye git</a >
                    </div>
                ...
                <div className="item group border  cursor-pointer mx-4">
                    ...
                    <div className={`h-[188px] w-96 transition-all hidden  group-hover:flex flex-col justify-center items-center `}>
                        ...
                        <a href='https://github.com/Baranplt/React-Api-Example---Gallery-app' target='_blank' className=' border text-white py-2 px-4 mt-5 hover:scale-110'>Projeye git</a >
                    </div>
